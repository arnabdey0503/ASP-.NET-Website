...
public partial class SearchResults : System.Web.UI.Page
{
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        if (im_ext == ".jpg" || im_ext == ".jpeg" || im_ext ==".JPG" || im_ext ==".JPEG")
        {
            ...
            Response.Redirect("SearchResults.aspx?dp=updated");
        }
        else
        {
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (i > 0)
        {
            Response.Redirect("SearchResults.aspx?post=successful");
        }
    }
    protected void Button3_Click(object sender, EventArgs e)
    {
        ...
        if (ext == ".jpg" || ext == ".jpeg" || ext == ".JPG" || ext == ".JPEG")
        {
            ...
            Response.Redirect("SearchResults.aspx?cover=updated");
        }
        else
        {
            Label3.Text = "Not an image...";
    ...
    protected void LinkButton4_Click(object sender, EventArgs e)
    {
        ...
        if (ext == ".jpg" || ext == ".jpeg" || ext == ".JPG" || ext == ".JPEG")
        {
            ...
            Response.Redirect("SearchResults.aspx?picture=updated");
        }
        else
        {
            Label3.Text = "Not an image...";
