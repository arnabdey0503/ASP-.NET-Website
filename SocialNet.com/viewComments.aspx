<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewComments.aspx.cs" Inherits="viewComments" %>
...
&nbsp;&nbsp;
              &nbsp;<br />
                <div style="overflow: scroll; height: 800px;">
                      <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="uid" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" PageSize="1">
                      ...
                      <Columns>
                          ...
                          <asp:TemplateField SortExpression="uPic">
                              ...
                              <ItemTemplate>
                                  <asp:Image ID="Image3" runat="server" Height="33px" ImageUrl='<%# Eval("uPic") %>' Width="43px" />
                              </ItemTemplate>
                          </asp:TemplateField>
                  ...
                  <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:con1 %>" SelectCommand="SELECT user_tb.uid, comments.comment, comments.dateTime, user_tb.uPic, user_tb.Name FROM comments INNER JOIN user_tb ON comments.pid = @pid AND comments.uid = user_tb.uid">
                      <SelectParameters>
