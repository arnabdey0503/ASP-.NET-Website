<%@ Page Language="C#" AutoEventWireup="true" CodeFile="memoryLane.aspx.cs" Inherits="memoryLane" %>
    ...
    <div class="header">
      ...
      <div class="menu_nav">
        <ul>
          ...
          <li class="active">       <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/memoryLane.aspx">Memory Lane</asp:HyperLink></li>
...
&nbsp;<asp:TextBox ID="TextBox2" placeholder="About the picture.." runat="server" Height="16px" Width="174px"></asp:TextBox>
              ...
              <br />
              <br />
                &nbsp;<%DataSet ds = DBAccess.FetchData("select distinct u.uPic ,u.Name ,p.post_id,p.uid,p.uid_sender,p.type,p.pic,p.msg,p.dateTime from user_tb as u inner join  posts as p on (u.uid =" + Session["uid"] + " and ( p.uid = " + Session["uid"] + " or p.uid_sender=" + Session["uid"] + ") ) order by dateTime desc");
                      for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                      {
                          ...
                          Session["prevPage"] = "memoryLane.aspx";
