      ...
      <div class="content_bg">
        <div class="mainbar">
          <div class="article">
            ...
            <h2><% Response.Write(Session["tmpname"].ToString()); %>  
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  
                <asp:Button ID="Button2" runat="server" Text="Add Friend" BackColor="#99CCFF" BorderStyle="Outset" ForeColor="#6A6A6A" OnClick="Button2_Click" />
              &nbsp;&nbsp;&nbsp;&nbsp;  
                <asp:Button ID="Button3" runat="server" Text="Send a msg" BackColor="#99CCFF" BorderStyle="Outset" ForeColor="#6A6A6A" OnClick="Button3_Click" />
              </h2>&nbsp;&nbsp;<asp:TextBox ID="TextBox1" runat="server" Height="60px" placeholder="Post on your friend's wall"  TextMode="MultiLine" Width="278px"></asp:TextBox>
...
&nbsp;<asp:TextBox ID="TextBox2" placeholder="About the picture.." runat="server" Height="16px" Width="174px"></asp:TextBox>
              ...
              <br />
               <br />
                  &nbsp;<%DataSet ds = DBAccess.FetchData("select distinct u.uPic ,u.Name ,p.post_id,p.uid,p.uid_sender,p.type,p.pic,p.msg,p.dateTime from user_tb as u inner join  posts as p on (u.uid =" + Session["tmpid"] + " and ( p.uid = " + Session["tmpid"] + " or p.uid_sender=" + Session["tmpid"] + ") ) order by dateTime desc");
                      for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                      {
                          ...
                          Session["prevPage"] = "viewProfile.aspx";
                ...
                <h3> <%= ds.Tables[0].Rows[i]["msg"].ToString() %>             </h3> 
                 ...
                 <% }//end of else %>
                   ...
                   <asp:HyperLink ID="HyperLink4" runat="server" ImageUrl="~/images/like.jpg" ImageWidth="40px" ></asp:HyperLink>
                  <asp:HyperLink ID="HyperLink5" runat="server" ImageUrl="~/images/unlike.jpg" ImageWidth="40px" Visible="False">HyperLink</asp:HyperLink>
                  ...
                  <asp:HyperLink ID="HyperLink6" runat="server" ImageUrl="~/images/comment.jpg" ImageWidth="24px" Visible="true"></asp:HyperLink>
                   <br />&nbsp;&nbsp;&nbsp; <asp:HyperLink ID="HyperLink7" runat="server">view likes</asp:HyperLink>
